...
//        {
//            _maNhanVien = authenticatedUser != null ? authenticatedUser.MaNV : null;
...
//            try
//            {
//                using (QuanLyThuVienEntities context = new QuanLyThuVienEntities())
//                {
//                    NhanVien user = context.NhanViens
//                        .Include(nv => nv.ChucVu)
//                        .FirstOrDefault(nv => nv.MaNV == _maNhanVien);
...
//                    Email = user.Email;
//                    Address = user.DiaChi;
//                    RoleName = user.ChucVu != null ? user.ChucVu.TenVaiTro : "Không xác định";
...
//                using (QuanLyThuVienEntities context = new QuanLyThuVienEntities())
//                {
//                    NhanVien user = context.NhanViens.FirstOrDefault(nv => nv.MaNV == _maNhanVien);
//                    if (user == null)
//                    {
